...
### ⏳ Этап 1: Фундаментальный функционал (MVP) - `Предстоит, ~3-4 недели`
...
*   **[ ] Задача 1.1: Продвинутая система калькуляции заказов**
    ...
    *   **[ ] Подзадача 1.1.3:** Реализовать `CalculatorService` с логикой расчета для 2-3 ключевых продуктов (например, значки, фрезерная резка, листовки).
